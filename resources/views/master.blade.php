...
<head>
    ...
    <title>فيلم زوين @yield('title')</title>
</head>
<body>
<!-- Just a logo -->
<nav>
    ...
    <div id="side-menu" class="side-nav">
        ...
        <div class="infos-perso">
            <img src="{{url('imgs/avatars/') . '/' . Auth::user()->avatar}}" alt="avatar">
            ...
            <div class="update-action">
                <a href="{{url('profile')}}">تعديل الملف الشخصي<i class="fa fa-cog" aria-hidden="true"></i></a>
        ...
        <div class="liste-option">
            ...
            <a href="ar_films">
                <span class="">الأفلام العربية</span>
            ...
            <form action="{{url('login')}}" method="POST" autocomplete="off">
                ...
                <div class="login">
                    <div class="login_content">
                        <i class="far fa-user user_login" aria-hidden="true"></i>

                        {{--The Username Input Field--}}
                        <input id="name" type="text" name="username" value="{{ old('username') }}" placeholder="إسم المستخدم" required autofocus>
                        <i class="far fa-unlock-alt user_pass" aria-hidden="true"></i>


                        {{--The Password Input Field--}}
                        <input id="password" type="password" name="password" placeholder="كلمة المرور" required>

                        {{--The submittion Button--}}
                        <button type="submit" class="btn btn-primary">{{ __('دخول') }}</button>
                ...
                <script>
                    var errors = {{ $errors->count() > 0 ? 'true' : 'false' }};
                    if ( errors ) {

                        swal({
                            title: "!خطأ",
                            text: "!إسم المستخدم أو كلمة المرور غير صحيحة",
                            icon: "error",
                            button: "الرجوع"
                        });
                    }
        ...
        @else
            <li class="nav-item dropdown">
                <div class="notificationDropdown">
                    <div class="dropdown-toggle userNavNotification" id="notificationdropdownMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <i class="fal fa-bell" title="إشعارات"></i>
                        <div class="numberOfUserNotification">
                            <span>0</span>
                        </div>
                    </div>
                    <div class="dropdown-menu text-center userNotificationDropdownMenu" aria-labelledby="notificationdropdownMenu">
                        <a class="dropdown-item">لا توجد أي إشعارات حاليا</a>
                    </div>
                </div>
                <div class="dropdown">
                    <img class="dropdown-toggle userPictureProfileNav" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" src="imgs/avatars/{{ Auth::user()->avatar }}" alt="userImageProfile">
                    <div class="dropdown-menu text-center userActionDropdownMenu" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href="{{url('home')}}">الملف الشخصي</a>
                        <a class="dropdown-item" href="{{url('profile')}}" title="حسابي">تعديل معلومات الحساب</a>
...
<footer>
    <div class="social">
        <ul>
            <li><a href="http://facebook.com/filmzwen"><i class="fab fa-facebook" aria-hidden="true"></i></a></li>
            <li><a href="https://www.instagram.com/filmzwen/"><i class="fab fa-instagram" aria-hidden="true"></i></a></li>
            <li><a href="https://twitter.com/filmzwen/"><i class="fab fa-twitter" aria-hidden="true"></i></a></li>
            <li><a href="http://youtube.com/filmzwen/"><i class="fab fa-youtube" aria-hidden="true"></i></a></li>
        </ul>
    </div>
