            ...
            <div class="watch_video">
                ...
                <div class="quality">
                    <div class="for-watching">
                        ...
                        <a href=""><button class="btn btn-danger">720p HD</button></a><br>
                    ...
                    <div class="for-download">
                        ...
                        <a href=""><button class="btn btn-success">720p HD</button></a><br>
            ...
            @else
                ...
                @foreach($film->comments as $comment)
                    <div class="all_comment">
                        ...
                        <input disabled type="text" value="{{$comment->comment}}">
